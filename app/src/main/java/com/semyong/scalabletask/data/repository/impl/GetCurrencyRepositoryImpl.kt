...
class GetCurrencyRepositoryImpl(private val getCurrencyListDataSourceFactory: GetCurrencyListDataSourceFactory, private val apiServices: ApiServices) :
    GetCurrencyRepository {
    override suspend fun getCurrencyList(): DataSource.Factory<Int, CurrencyItem> = getCurrencyListDataSourceFactory
    override suspend fun getCurrencyProfile(symbol:String): CurrencyItem  = apiServices.getCurrencyProfile(symbol)
}